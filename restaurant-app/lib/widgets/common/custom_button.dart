...
/// Restaurant open/close toggle button
class RestaurantStatusButton extends StatelessWidget {
  final bool isOpen;
  ...
  Widget build(BuildContext context) {
    return CustomButton(
      ...
      icon: isOpen ? Icons.store : Icons.store_outlined,
      backgroundColor: isOpen ? AppColors.restaurantOpen : AppColors.restaurantClosed,
