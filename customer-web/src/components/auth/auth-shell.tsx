...
/**
 * Shared shell for every auth page: centered card on desktop, full-width
 * on mobile, brand at top, optional CTA + footer at bottom.
 */
export function AuthShell({ title, subtitle, footer, children }: AuthShellProps) {
  return (
    <main id="main" className="container mx-auto flex max-w-md flex-col gap-8 px-4 py-12">
      <Link href="/" className="flex items-center gap-2 self-start" aria-label="Bagour Delivery">
        <span
          aria-hidden
        ...
        <span className="text-base font-semibold">Bagour Delivery</span>
      </Link>
