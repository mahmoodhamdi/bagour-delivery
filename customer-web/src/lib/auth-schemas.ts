...
/**
 * Form-side Zod schemas. Mirror the server-side payload schemas in
 * @bagour/types/schemas but bake i18n message keys instead of English so
 * react-hook-form errors can be translated with the same `t()` call as
