...
const DISMISS_KEY = "bagour-driver-pwa-install-dismissed";
const DISMISS_DAYS = 14;

/**
 * Native PWA install prompt for driver-web. Drivers benefit most from
 * "Add to Home Screen" since the app is meant to run full-screen with
 * Wake Lock during shifts — installing improves that experience.
 */
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 space-y-2">
          ...
          <div className="flex items-center gap-2">
            <Button size="sm" onClick={() => void handleInstall()} data-testid="pwa-install-accept">
              {t("installButton")}
            </Button>
            <Button variant="ghost" size="sm" onClick={handleDismiss} data-testid="pwa-install-dismiss">
              {t("dismiss")}
            </Button>
          </div>
        </div>
