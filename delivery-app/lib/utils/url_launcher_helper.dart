...
class UrlLauncherHelper {
  ...
  static const String supportEmail = 'driver-support@bagour.com';
  ...
  /// Launch navigation to an address
  ...
  static Future<bool> launchSupportPhone() async {
    return launchPhone(supportPhone);
  }
  ...
  static Future<bool> launchSupportEmail({String? subject}) async {
    return launchEmail(
      supportEmail,
      subject: subject ?? 'دعم تطبيق سائقي الباجور',
    );
  }
  ...
  static Future<bool> launchSupportWhatsApp({String? message}) async {
    return launchWhatsApp(
      supportPhone,
      message: message ?? 'مرحباً، أنا سائق وأحتاج مساعدة',
    );
  }
